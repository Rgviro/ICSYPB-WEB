	  ...
	  <img style="max-width:70px; margin-top: -10px;" src="<?=base_url()?>assets/Images/upsam.png"></a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">            
            <li class="dropdown">            
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Gesti&oacute;n Usuarios <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href='<?=base_url()?>gestion/gestorusuarios/crud_gestorusuarios'>Alta Usuarios</a></li>
                <li><a href='<?=base_url()?>gestion/gestorusuarios/crud_cambiopassword'>Datos LogIn</a></li>                  
              </ul>
            </li>                        
            <li class="dropdown">            
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Gesti&oacute;n Balizas <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href='<?=base_url()?>gestion/gestorgrupos/crud_gestorgruposgestor'>Crear Baliza</a></li>
